...
if (!class_exists('Spice_Software_About_Page')) {
	class Spice_Software_About_Page {
		...
		function __construct() {
			...
			add_action( 'spice_software_info_screen', array( $this, 'one_click_demo_actions' ), 	50 );
	    ...
	    public function one_click_demo_actions() {
			require_once( SPICE_SOFTWARE_TEMPLATE_DIR . '/admin/tab-pages/one-click-demo-import.php' );
		}
		...
		public function get_tabs_array() {
		    ...
		    $tabs_array[]	= 	array(
					'link'      => 'one_click_demo',
					'name'      => esc_html__('One Click Demo Import', 'spice-software' ),
			);
...
function spice_software_recommended_plugins_array($plugins){
		...
		$plugins[] = array(
						...
						'slug'     => 'spicebox',
						'desc'     => esc_html__('To access the advanced Frontpage sections and the other features, please install the Spice Box plugin.', 'spice-software' ),
					);
				
		$plugins[] = array(
					'name'     => esc_html__('Contact Form 7', 'spice-software' ),
					'slug'     => 'contact-form-7',
					'desc'     => esc_html__('To display the contact form, please install the Contact Form 7 plugin.', 'spice-software' ),
				);
		...
		$plugins[] = array(
					...
					'slug'     => 'wordpress-seo',
					'desc'     => esc_html__('To display breadcrumbs, please install the Yoast SEO plugin.', 'spice-software'),
				    );
	return $plugins;
}
